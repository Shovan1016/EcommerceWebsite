let Item=(props)=>
{
    return(
      ...
      <div className="flex flex-col justify-center">
          <button className="bg-yellow-300 mb-4 p-5 w-72 font-bold text-3xl rounded-3xl border-2 border-black hover:bg-yellow-500"> <span> Add To Cart</span> <span></span> </button>
          <button className="bg-red-500 p-5 w-72 font-bold text-3xl rounded-3xl border-2 border-black hover:bg-red-700"> <span>Buy Now</span> <span></span> </button>
